...
import { 
  LayoutDashboard, School, Users, UserCog, CalendarDays, BarChart3, LogOut, ShieldAlert, Menu, X, Sun, Moon 
} from 'lucide-react';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    ...
    { name: 'Academic Years', path: '/admin/academic-years', icon: CalendarDays },
  ...
  const renderSidebarContent = () => (
    <>
        ...
        <div className="h-16 flex items-center justify-between lg:justify-start gap-3 px-6 border-b border-white/5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] text-gray-500 font-semibold uppercase tracking-wider">Control Panel</span>
            </div>
          </div>
          <button
      ...
      <div className="p-4 border-t border-white/5">
        <div className="flex items-center justify-between gap-3 px-3 py-2 bg-[#0e1624] rounded-xl border border-white/5 mb-3">
          <div className="truncate">
            <p className="text-xs font-semibold truncate">{name}</p>
            <span className="text-[9px] font-bold text-emerald-400 uppercase tracking-widest">Administrator</span>
          </div>
          <button
            type="button"
