...
const TeacherStudents: React.FC = () => {
  ...
  const openEditModal = (student: Student) => {
    ...
    setStudentIdNo(student.student_id_no || '');
  ...
  const handleSaveStudent = async (e: React.FormEvent) => {
    ...
    const payload = {
      name,
      student_id_no: studentIdNo || null,
      gender: gender || null,
      dob: dob || null,
        ...
        <div className="glass-card rounded-2xl p-4">
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              placeholder="Search by name or student ID no."
                ...
                <tbody className="divide-y divide-white/5 text-sm">
                  {students.map((student) => (
                    <tr key={student.id} className="hover:bg-white/5 transition-colors">
                      ...
                      <td className="px-4 py-4 text-gray-300 font-mono text-xs whitespace-nowrap">{student.student_id_no || '-'}</td>
            ...
            <div className="w-full max-w-lg bg-[#0a0f18] border border-white/10 rounded-2xl p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto">
              ...
              <form onSubmit={handleSaveStudent} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Student ID No</label>
                    <input
                      type="text"
                      maxLength={20}
                      value={studentIdNo}
              ...
              <div className="p-6 border-b border-white/5 flex justify-between items-start bg-white/5">
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    {studentHistory.student_name} ({studentHistory.student_id_no || 'No ID'})
                  </p>
                </div>
                <button
